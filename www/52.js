...
/* harmony import */ var _index_c58c7441_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-c58c7441.js */ "./node_modules/@ionic/core/dist/esm-es5/index-c58c7441.js");
...
var createBaseAnimation = function (pullingRefresherIcon) {
    ...
    var baseAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
        .duration(1000)
        .easing('ease-out');
    var spinnerArrowContainerAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
    ...
    var circleInnerAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
        .addElement(circle)
        .keyframes([
    ...
    var circleOuterAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
        .addElement(spinner)
        .keyframes([
    ...
    if (arrowContainer && arrow) {
        var arrowContainerAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
        ...
        var arrowAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
            .addElement(arrow)
            .keyframes([
...
var createScaleAnimation = function (pullingRefresherIcon) {
    ...
    var spinnerAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
...
var createSnapBackAnimation = function (pullingRefresherIcon) {
    return Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_4__["c"])()
        .duration(125)
        .addElement(pullingRefresherIcon)
...
var handleScrollWhilePulling = function (spinner, ticks, opacity, currentTickToShow) {
    Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["w"])(function () {
...
var Refresher = /** @class */ (function () {
    function class_1(hostRef) {
         ...
         */
        this.disabled = false;
        this.ionRefresh = Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionRefresh", 7);
        this.ionPull = Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionPull", 7);
        this.ionStart = Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionStart", 7);
    }
    ...
    class_1.prototype.checkNativeRefresher = function () {
        var useNativeRefresher = shouldUseNativeRefresher(this.el, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this));
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.state = state;
                        if (!(Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this) === 'ios')) return [3 /*break*/, 2];
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["w"])(function () { return ticks.forEach(function (el) { return el.style.setProperty('animation', 'none'); }); });
                        this.scrollListenerCallback = function () {
                            // If pointer is not on screen or refresher is not active, ignore scroll
                            if (!_this.pointerDown && _this.state === 1 /* Inactive */) {
                                return;
                            }
                            Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["f"])(function () {
                                ...
                                if (scrollTop > 0) {
                                    ...
                                    if (_this.state === 8 /* Refreshing */) {
                                        ...
                                        Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["w"])(function () { return setSpinnerOpacity(refreshingSpinner, 1 - ratio_1); });
                                        return;
                                    }
                                    Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["w"])(function () { return setSpinnerOpacity(pullingSpinner, 0); });
                                    return;
                                }
                        ...
                        _a.gesture = (_b.sent()).createGesture({
                            ...
                            onEnd: function () {
                                ...
                                if (_this.needsCompletion) {
                                    ...
                                    Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["f"])(function () { return translateElement(_this.elementToTransform, _this.el.clientHeight + "px"); });
                                }
                            },
                        });
                    ...
                    case 1:
                        _a.gesture = (_b.sent()).createGesture({
                            ...
                            onEnd: function (ev) {
                                ...
                                Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["w"])(function () { return _this.scrollEl.style.removeProperty('--overflow'); });
                                ...
                                Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["w"])(function () { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
                                    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
    ...
    class_1.prototype.setupNativeRefresher = function (contentEl) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                ...
                if (Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this) === 'ios') {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!shouldUseNativeRefresher(this.el, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this))) return [3 /*break*/, 2];
                        this.setupNativeRefresher(contentEl);
                        return [3 /*break*/, 4];
                    case 2:
                        _b = this;
    ...
    class_1.prototype.render = function () {
        ...
        return (Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["H"], { slot: "fixed", class: (_a = {},
                _a[mode] = true,
...
var RefresherContent = /** @class */ (function () {
    ...
    RefresherContent.prototype.render = function () {
        ...
        var mode = Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this);
        return (Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["H"], { class: mode }, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "refresher-pulling" }, this.pullingIcon && hasSpinner &&
            Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "refresher-pulling-icon" }, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "spinner-arrow-container" }, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-spinner", { name: this.pullingIcon, paused: true }), mode === 'md' && this.pullingIcon === 'circular' &&
                Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "arrow-container" }, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { name: "caret-back-sharp" })))), this.pullingIcon && !hasSpinner &&
            Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "refresher-pulling-icon" }, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { icon: this.pullingIcon, lazy: false })), this.pullingText &&
            Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "refresher-pulling-text", innerHTML: Object(_index_3476b023_js__WEBPACK_IMPORTED_MODULE_12__["s"])(this.pullingText) })), Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "refresher-refreshing" }, this.refreshingSpinner &&
            Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "refresher-refreshing-icon" }, Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-spinner", { name: this.refreshingSpinner })), this.refreshingText &&
            Object(_core_0a8d4d2e_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "refresher-refreshing-text", innerHTML: Object(_index_3476b023_js__WEBPACK_IMPORTED_MODULE_12__["s"])(this.refreshingText) }))));
    };
